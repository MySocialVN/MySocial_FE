...
const CommonFriend = () => {
    ...
    useEffect(() => {
        const fetchUserProfile = async () => {
            ...
            try {
                const response = await axios.get(`${API_URL}/api/users/common-friends/${friendId}`, {
                    headers: {
    ...
    useEffect(() => {
        const fetchUserProfile1 = async () => {
            ...
            try {
                const response = await axios.get(`${API_URL}/api/users/user/view/${friendId}`, {
                    headers: {
                        ...
                        <div className="col-xl-12">
                            <div className="card shadow-xss w-100 d-block d-flex border-0 p-4 mb-3">
                                <div className="card-body d-flex align-items-center p-0">
                                    <h2 className="fw-700 mb-0 mt-0 font-md text-grey-900">Bạn bè chung cùng với: {viewProfile.fullName}</h2>
